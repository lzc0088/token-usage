...
<div class="sc">
  ...
  <div class="section-box">
    <div class="box-row">
      ...
      <Dropdown class="sel" value={config.currency} options={[
    ...
    <div class="box-row">
      ...
      <Dropdown class="sel" value={rateMode} options={[
        {value: "auto", label: t('general.rateAuto')},
        {value: "manual", label: t('general.rateManual')},
      ]} onChange={(v) => { rateMode = v as 'auto' | 'manual'; onUpdate({ rate_mode: v as "auto" | "manual" }); }} />
    </div>
    {#if rateMode === 'auto'}
