...
export const VENDORS: VendorDef[] = [
  ...
  },
  {
    ...
    authType: "cookie",
    desc: "阶跃星辰 StepFun。推荐填写账号密码自动登录（Cookie 方式数分钟即失效）；查询账户余额与 Step Plan Credit",
    tags: [
    ...
    fields: [
      {
        key: "username",
        label: "账号（推荐）",
        enLabel: "Account (recommended)",
        placeholder: "手机号 / 邮箱，自动登录并保持会话",
        enPlaceholder: "Phone / email — auto login with session keep-alive",
        type: "text",
        optional: true,
      },
      {
        ...
        label: "密码",
        enLabel: "Password",
        placeholder: "StepFun 密码，仅本地加密保存",
        enPlaceholder: "StepFun password, stored locally encrypted",
        type: "password",
        optional: true,
      },
      {
        key: "cookie",
        label: "Cookie（易过期，备用）",
        enLabel: "Cookie (expires fast, fallback)",
